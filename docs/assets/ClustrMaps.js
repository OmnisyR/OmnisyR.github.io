...
function main() {
            addJs('https://clustrmaps.com/bl/scripts/counter.js', "2186215");
...
function embed_clustrmaps(script_el, embed_after_script){
    ...
    if($('#clustrmaps-widget-v2').length === 0){
        ...
        */
                            var link = '<a target="_top" href="http://clustrmaps.com/site/1auw7" title="ClustrMaps People Search" id="clustrmaps-widget-v2">';
