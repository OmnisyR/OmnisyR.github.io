...
\tag{14}
\\
&= \underbrace{(\frac{\alpha_t}{1 - \alpha_t} + \frac{1}{1 - \bar{\alpha}\_{t - 1}})}\_{\frac{1}{\Sigma}}x^2_{t - 1} - 2(\frac{\sqrt{\alpha_t}}{1 - \alpha_t}x_t + \frac{\sqrt{\bar{\alpha}\_{t - 1}}}{1 - \bar{\alpha}\_{t - 1}}x_0)x_{t - 1} + C(x_0, x_t)
\tag{15}
\end{align}
$$
